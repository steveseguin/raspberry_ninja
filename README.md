...
**New to Raspberry Pi?** Use the short [Quick start](QUICK_START.md). It can set up a camera sender or unattended TV receiver without choosing codecs or writing a service file.
