            ...
            if args.h264:
                ...
                if args.nvidia:
                    ...
                    if args.omx:
                        ...
                        pipeline_video_input += f' ! v4l2convert ! video/x-raw,format=I420,width=(int){width},height=(int){height} ! queue max-size-buffers=1 ! openh264enc bitrate={args.bitrate} complexity=0 ! video/x-h264,profile=constrained-baseline,stream-format=(string)byte-stream'
                    else:
