...
- fix: stabilize v4l2 loopback viewer output (d306e5f)
...
- fix: harden codec selection and reconnect signaling (a94f19f)
- fix: handle recorder interrupts cleanly (5d44bca)
...
- fix: skip camera discovery for test sources (e5083a2)
...
- fix: harden unattended Pi operation (b1c8503)
...
- feat: support native H264 USB webcams (d5e211d)
...
- fix: negotiate supported HDMI display modes (c53f7b9)
...
- fix: keep Pi receiver output on local HDMI (469261d)
...
- fix: harden reconnect signaling and recording discovery (43d1e23)
...
- fix: harden legacy Pi media pipelines (b9fc257)
- fix: record H264 streams as MPEG-TS (8154b5e)
...
- fix: finalize subprocess recordings cleanly (e557bdf)
...
- fix: route single-stream recording offers (2b04df8)
...
- Support low-memory Pi Zero 2 W deployments (b85f5f8)
...
- Fix configuration, recording, and Pi test bench reliability (9567b9a)
...
- fix(v4l2): rebuild sink after viewer reset (9b60102)
